        ...
        resp = openai_client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": (
                    ...
                    "'tes'='tee' (plural informal de tee para plafón). "
                    "SINÓNIMOS IMPORTANTES: 'tes principal'='tee principal', "
                    "'tes secundaria'='tee secundaria', 'tes de .61'='tee 61', "
                    "'tes de 1.22'='tee 1.22', 'placas de 61x61'='plafon registrable', "
                    "'galletas'='plafon registrable'. "
                    "Si dice 'X o Y' (ej: 'placas o galletas'), son sinónimos del mismo producto, "
                    "extrae UNO solo con el nombre más descriptivo. "
                    "Ejemplos correctos:\n"
