            ...
            messages=[{
                ...
                "content": [
                    ...
                    {"type": "text", "text": (
                        ...
                        "Transcribe el texto del producto TAL CUAL aparece en la imagen, sin modificar ni expandir abreviaturas. "
                        "Conserva medidas y especificaciones tal cual aparecen (ej: 'Cal 26', 'C24', '1/2\"', '6 x 1', '10 x 1 1/2'). "
