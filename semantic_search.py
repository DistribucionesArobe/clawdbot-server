...
def _gpt_smart_match(conn, company_id: str, user_query: str,
    ...
    system_prompt = (
        ...
        "- NUNCA expliques. Solo número(s) o NO.\n\n"
        "DEBES SER FLEXIBLE con errores de escritura y jerga. Ejemplos:\n"
        ...
        "- 'tes' = 'tee' (plural informal). 'tes principal' = 'tee principal'\n"
        "- 'tes secundaria de .61' = 'tee 61' o 'tee secundaria 61'\n"
        "- 'tes secundarias de 1.22' = 'tee 1.22' o 'tee secundaria 1.22'\n"
        "- 'placas de 61x61' o 'galletas' = 'plafon registrable'\n"
        "- 'prinsipal' = 'principal', 'segundaria' = 'secundaria'\n\n"
        "USA TU CONOCIMIENTO: Eres ferretero experto. Si el cliente usa jerga, "
        "apodos o nombres informales, USA TU EXPERIENCIA para deducir qué producto "
        "del catálogo corresponde. No te limites solo a los ejemplos de arriba.\n\n"
        "MARCAS DE COMPETIDORES: Si el cliente menciona una marca que NO aparece "
        "en el catálogo (GlassRey, Ternium, Galvak, Deacero, Villacero, "
        "Stabilit, USG, Plaka, Panel Rey, Multypanel, MaxAcero, etc.), "
        "IGNORA la marca y busca el producto equivalente en nuestro catálogo. "
        "Ejemplo: 'GlassRey canal 6.35' → busca 'canal 6.35'. "
        "'Ternium lámina R72' → busca 'lámina R72'. "
        "El cliente quiere ESE TIPO de producto, no esa marca específica.\n\n"
